 ...
 * @property {string | (string | ConfigData)[]} [extends] The path to other config files or the package name of shareable configs.
 ...
 * @property {string[] | Record<string, string | Plugin>} [plugins] The plugin specifiers.
